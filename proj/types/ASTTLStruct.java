...
public class ASTTLStruct implements ASTType {

    private TypeBindList ll;

    public ASTTLStruct(TypeBindList llp) {
        ll = llp;
    }

    public String toStr() {
        String res = "linear struct {";
    ...
    public boolean isSubtypeOf(ASTType o, Environment<ASTType> e) throws InterpreterError {
        ...
        } else if (o instanceof ASTTLStruct) {
            HashMap<String, ASTType> mb = ((ASTTLStruct) o).getList().getMap();
